import { Actor, Vector, BoundingBox, Color, Scene, CollisionType, GraphicsGroup } from "excalibur"
    ...
    async onInitialize() {
        ...
        Enemy.prototype.spawn = function() {
            ...
            while (!validSpawn && attempts < 100) {
                ...
                if (this.scene.player && this.scene.player.pos.distance(this.pos) <= 700) {
                    attempts++;
                    continue;
                }

                const inWall = this.scene.actors.some(actor => 
                    actor !== this && 
